package com.example.seniorproject_discreetdispatch // Updated package
...
@Composable
fun PoliceScreen(onBackClick: () -> Unit, onFinishClick: (String) -> Unit) {
    ...
    Scaffold(
        ...
        Column(
            ...
            // These utilize the functions in your CommonUI.kt
            ...
            FormField(
                label = "If so, how many persons and what are their conditions?",
                value = othersDetails,
            ...
            FormField(
                label = "Describe the offender or offenders:",
                value = offenderDetails,
                onValueChange = { offenderDetails = it },
                hint = "Gender, Race, Height, Clothing, etc."
            )
