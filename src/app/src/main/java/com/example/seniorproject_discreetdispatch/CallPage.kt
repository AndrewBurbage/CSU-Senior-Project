...
import com.example.seniorproject_discreetdispatch.network.ApiClient // Updated import
import com.example.seniorproject_discreetdispatch.ui.theme.SeniorProjectDiscreetDispatchTheme // Import theme
...
class CallPage : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            SeniorProjectDiscreetDispatchTheme { // Updated theme
                CallPageScreen(
                    script = script,
                    onBackClick = { finish() },
